...
public class InventLog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ResetPass.setOnClickListener(v -> {
            startActivity(new Intent(getApplicationContext(), InventReset.class));
        });
        ...
        btnLog.setOnClickListener(v -> {
            ...
            if (myUser.isEmpty() || myPass.isEmpty()) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, Manage.lSto,
                        response -> {
                            try {
                                ...
                                if (status.equals("1")) {
                                    ...
                                    for (int i = 0; i < dataArray.length(); i++) {
                                        ...
                                        inventSession.loginInvent(serial_no, fname, lname, email, phone, role, username, sstatus, date);
                                    }
