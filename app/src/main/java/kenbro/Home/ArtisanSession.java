...
public class ArtisanSession {
    private static final String preference = "professor";
    ...
    public ArtisanSession(Context mContext) {
    ...
    public void loginArt(String serial_no, String fname, String lname, String email, String phone, String role, String username,
     ...
     * @return user details
     */
    public StaffModel getArtDetails() {
