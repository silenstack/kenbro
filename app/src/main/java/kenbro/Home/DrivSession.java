...
public class DrivSession {
    private static final String preference = "Weye";
    private static final String kentry_no = "entry_no";
    private static final String klicense = "license";
    ...
    public DrivSession(Context mContext) {
    ...
    public void loginDriv(String entry_no, String license, String fname, String lname, String email, String phone, String address, String username,
                          String status, String reg_date) {
        mEditor.putString(kentry_no, entry_no);
        mEditor.putString(klicense, license);
     ...
     * @return user details
     */
    public DrivModel getDrivDetails() {

        if (!loggedDriv()) {
            return null;
        }
        DrivModel custModel = new DrivModel();
        custModel.setEntry_no(mPreferences.getString(kentry_no, keyempty));
        custModel.setLicense(mPreferences.getString(klicense, keyempty));
