...
public class UssrAda extends ArrayAdapter<UssrMode> {
    public ArrayList<UssrMode> MainList;
    public ArrayList<UssrMode> SubjectListTemp;
    public UssrAda.SubjectDataFilter subjectDataFilter;

    public UssrAda(Context context, int id, ArrayList<UssrMode> subjectArrayList) {
