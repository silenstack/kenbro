...
public class FinaSession {
    private static final String preference = "Natella";
    ...
    public FinaSession(Context mContext) {
    ...
    public void loginfina(String serial_no, String fname, String lname, String email, String phone, String role, String username,
     ...
     * @return user details
     */
    public StaffModel getFinaDetails() {
