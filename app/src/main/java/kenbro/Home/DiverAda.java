...
public class DiverAda extends ArrayAdapter<PayModel> {
    public ArrayList<PayModel> MainList;
    public ArrayList<PayModel> SubjectListTemp;
    public DiverAda.SubjectDataFilter subjectDataFilter;

    public DiverAda(Context context, int id, ArrayList<PayModel> subjectArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        int pos = position + 1;
        holder.Mpesa.setText(subject.getPhone());
