...
public class InstalSession {
    private static final String preference = "Habak";
    ...
    public InstalSession(Context mContext) {
    ...
    public void loginInstal(String serial_no, String fname, String lname, String email, String phone, String role, String username,
     ...
     * @return user details
     */
    public StaffModel getInstalDetails() {
