...
public class ProdAda extends ArrayAdapter<ProdMode> {
    public ArrayList<ProdMode> MainList;
    public ArrayList<ProdMode> SubjectListTemp;
    public SubjectDataFilter subjectDataFilter;

    public ProdAda(Context context, int id, ArrayList<ProdMode> subjectArrayList) {
