...
public class ModelAda extends ArrayAdapter<ModelBid> {
    public ArrayList<ModelBid> bidModels;
    public ArrayList<ModelBid> bidModelArrayList;
    public BidDateFilter bidDateFilter;

    public ModelAda(Context context, int id, ArrayList<ModelBid> subjectArrayList) {
