...
public class InstallLog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Installer Login");
        ...
        ResetPass.setOnClickListener(v -> {
            startActivity(new Intent(getApplicationContext(), InstallReset.class));
        });
        CreateAccount.setOnClickListener(v -> {
            startActivity(new Intent(getApplicationContext(), InstallReg.class));
        });
        btnLog.setOnClickListener(v -> {
            ...
            if (myUser.isEmpty() || myPass.isEmpty()) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, Manage.lIns,
                        response -> {
                            try {
                                ...
                                if (status.equals("1")) {
                                    ...
                                    for (int i = 0; i < dataArray.length(); i++) {
                                        ...
                                        instalSession.loginInstal(serial_no, fname, lname, email, phone, role, username, sstatus, date);
                                    }
