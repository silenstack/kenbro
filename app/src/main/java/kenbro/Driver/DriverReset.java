...
public class DriverReset extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver_reset);
        ...
        btnReset.setOnClickListener(v -> {
            ...
            if (myUser.isEmpty() || myPass.isEmpty() || myReset.isEmpty()) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, Manage.uDri,
                        response -> {
                            try {
