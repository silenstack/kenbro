...
public class DriverReg extends AppCompatActivity {
    EditText First, Last, Email, Password, Confirm, License, Username;
    MaskEditText Phone;
    Spinner residence;
    Button btnRegister;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Register Driver");
        ...
        btnRegister.setOnClickListener(v -> {
            ...
            final String myLicense = License.getText().toString().trim();
            ...
            if (myFirst.isEmpty() || myLast.isEmpty() || myEmail.isEmpty() || myUser.isEmpty() || myPhone.isEmpty() || myPass.isEmpty() || myConfirm.isEmpty()) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, Manage.rDri,
                        response -> {
                            try {
