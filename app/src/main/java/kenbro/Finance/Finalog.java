...
public class Finalog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Finance Login");
        setContentView(R.layout.activity_finalog);
        ...
        ResetPass.setOnClickListener(v -> {
            startActivity(new Intent(getApplicationContext(), FinaReset.class));
        });
        CreateAccount.setOnClickListener(v -> {
            startActivity(new Intent(getApplicationContext(), FinaReg.class));
        });
        btnLog.setOnClickListener(v -> {
            ...
            if (myUser.isEmpty() || myPass.isEmpty()) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, Manage.lFin,
                        response -> {
                            try {
                                ...
                                if (status.equals("1")) {
                                    ...
                                    for (int i = 0; i < dataArray.length(); i++) {
                                        ...
                                        finaSession.loginfina(serial_no, fname, lname, email, phone, role, username, sstatus, date);
                                    }
