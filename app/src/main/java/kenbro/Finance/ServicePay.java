...
public class ServicePay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Service Payments");
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            builder.setNeutralButton("Verify", (dd, d) -> {
            });
            ...
            alertDialog.getButton(DialogInterface.BUTTON_NEUTRAL).setOnClickListener(view1 -> {
                ...
                alert.setNeutralButton("Reject", (dr, e) -> {
                });
                ...
                dede.getButton(DialogInterface.BUTTON_NEGATIVE).setOnClickListener(view11 -> {
                    dede.cancel();
                });
                dede.getButton(DialogInterface.BUTTON_NEUTRAL).setOnClickListener(view11 -> {
                    Toast.makeText(this, Html.fromHtml("<font color='green'>Please long press the Reject Button</font>"), Toast.LENGTH_SHORT).show();
                });
                dede.getButton(DialogInterface.BUTTON_POSITIVE).setOnClickListener(view11 -> {
                    Toast.makeText(this, Html.fromHtml("<font color='green'>Please long press the Approve Button</font>"), Toast.LENGTH_SHORT).show();
                });

                dede.getButton(DialogInterface.BUTTON_NEUTRAL).setOnLongClickListener(view11 -> {
                    requestQueue = Volley.newRequestQueue(getApplicationContext());
                    requestQueue.add(new StringRequest(Request.Method.POST, Manage.supi,
                            response -> {
                                try {
                        ...
                        protected Map<String, String> getParams() throws AuthFailureError {
                            ...
                            para.put("payid", ussrMode.getPayid());
                            para.put("status", "2");
                            para.put("fina", "2");
                            para.put("amount", ussrMode.getAmount());
                ...
                dede.getButton(DialogInterface.BUTTON_POSITIVE).setOnLongClickListener(view11 -> {
                    requestQueue = Volley.newRequestQueue(getApplicationContext());
                    requestQueue.add(new StringRequest(Request.Method.POST, Manage.supi,
                            response -> {
                                try {
                ...
                response -> {
                    try {
                        ...
                        if (success == 1) {
                            ...
                            ussrAda = new UssrAda(ServicePay.this, R.layout.acc, ussrModeArrayList);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.App:
                startActivity(new Intent(getApplicationContext(), AppServ.class));
                break;
            case R.id.Reje:
                startActivity(new Intent(getApplicationContext(), RejServ.class));
                break;
            default:
        }
