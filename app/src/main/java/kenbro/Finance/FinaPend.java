...
public class FinaPend extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fina_pend);
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            alertDialog.getButton(DialogInterface.BUTTON_POSITIVE).setOnClickListener(view1 -> {
                ...
                requestQueue.add(new StringRequest(Request.Method.POST, Manage.cant,
                        response -> {
                            try {
                    ...
                    protected Map<String, String> getParams() throws AuthFailureError {
                        ...
                        para.put("comment", "Thanks for shopping with us.");
                        para.put("status", "1");
                        para.put("amount", payModel.getAmount());
            ...
            alertDialog.getButton(DialogInterface.BUTTON_NEGATIVE).setOnClickListener(view1 -> {
                ...
                requestQueue.add(new StringRequest(Request.Method.POST, Manage.cant,
                    ...
                    protected Map<String, String> getParams() throws AuthFailureError {
                        Map<String, String> para = new HashMap<>();
                        para.put("payid", payModel.getPayid());
                        para.put("comment", "Payment was rejected. You gave suspicious information.");
                        para.put("status", "2");
                        para.put("amount", payModel.getAmount());
                        para.put("date", new SimpleDateFormat("yyyy-MM-dd hh:mm a").format(new Date()));
                        return para;
                        ...
                        response -> {
                            try {
                                ...
                                if (success == 1) {
                                    ...
                                    cartAda = new WordProm(FinaPend.this, R.layout.category, cartModArrayList);
                ...
                response -> {
                    try {
                        ...
                        if (success == 1) {
                            ...
                            payAda = new PayAda(FinaPend.this, R.layout.acc, payModelArrayList);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.App:
                startActivity(new Intent(getApplicationContext(), ApprovP.class));
                break;
            case R.id.Reje:
                startActivity(new Intent(getApplicationContext(), RejectP.class));
                break;
            default:
        }
