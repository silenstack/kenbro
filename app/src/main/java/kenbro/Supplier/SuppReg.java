...
public class SuppReg extends AppCompatActivity {
    EditText First, Last, Email, Password, Confirm, Business, Username;
    MaskEditText Phone;
    Spinner residence;
    Button btnRegister;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Register Supplier");
        setContentView(R.layout.activity_supp_reg);
        First = findViewById(R.id.fname);
        Last = findViewById(R.id.lname);
        Business = findViewById(R.id.business_no);
        ...
        btnRegister.setOnClickListener(v -> {
            ...
            final String myRole = residence.getSelectedItem().toString().trim();
            ...
            if (myFirst.isEmpty() || myLast.isEmpty() || myEmail.isEmpty() || myUser.isEmpty() || myPhone.isEmpty() || myPass.isEmpty() || myConfirm.isEmpty()) {
                ...
                Toast.makeText(this, "Location no selected", Toast.LENGTH_SHORT).show();
            } else {
                StringRequest stringRequest = new StringRequest(Request.Method.POST, Manage.rSup,
                        response -> {
                            try {
                    ...
                    protected Map<String, String> getParams() {
                        ...
                        params.put("business_no", myBusiness);
                        params.put("username", myUser);
                        params.put("email", myEmail);
                        params.put("phone", myPhone);
                        params.put("residence", myRole);
