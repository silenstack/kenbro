...
public class SupDash extends AppCompatActivity {
    ...
    private void getProd() {
        requestQueue = Volley.newRequestQueue(getApplicationContext());
        requestQueue.add(new StringRequest(Request.Method.POST, Manage.seeS,
                response -> {
                    try {
                        ...
                        if (success == 1) {
                            ...
                            modelAda = new PesaAda(SupDash.this, R.layout.see_b, modelBidArrayList);
