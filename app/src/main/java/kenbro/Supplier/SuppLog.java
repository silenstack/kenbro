...
public class SuppLog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Supplier Login");
        setContentView(R.layout.activity_supp_log);
        ...
        btnLog.setOnClickListener(v -> {
            ...
            if (myUser.isEmpty() || myPass.isEmpty()) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, Manage.lSup,
                        response -> {
                            try {
                                ...
                                if (status.equals("1")) {
                                    ...
                                    for (int i = 0; i < dataArray.length(); i++) {
                                        ...
                                        String business_no = dataobj.getString("business_no");
                                        ...
                                        supSession.loginSup(entry_no, business_no, fname, lname, email, phone, address, username, sstatus, date);
                                    }
