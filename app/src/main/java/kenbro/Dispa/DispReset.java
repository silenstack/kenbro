...
public class DispReset extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_disp_reset);
        ...
        btnReset.setOnClickListener(v -> {
            ...
            if (myUser.isEmpty() || myPass.isEmpty() || myReset.isEmpty()) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, Manage.uDip,
                        response -> {
                            try {
