...
public class DispReg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Register Dispatcher");
        setContentView(R.layout.activity_disp_reg);
        ...
        ArrayAdapter<CharSequence> adapter1 = ArrayAdapter.createFromResource(this, R.array.dis, android.R.layout.simple_spinner_item);
